...
tk.Label(window, text="Return Date").grid(row=4, column=0, padx=10, pady=10, sticky="w")
tk.Label(window, text="Row").grid(row=5, column=0, padx=10, pady=10, sticky="w")
...
table = ttk.Treeview(
    window,
    columns=("id", "name", "receipt", "item", "qty", "return"),
    show="headings",
    height=10
)
...
table.column("receipt", width=130)
table.column("item", width=150)
table.column("qty", width=80, anchor="center")
table.column("return", width=120, anchor="center")

table.grid(row=6, column=0, columnspan=4, padx=10, pady=30)
